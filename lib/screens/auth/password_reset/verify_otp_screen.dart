...
import 'package:hoop/screens/auth/password_reset/reset_password_screen.dart';
...
class _VerifyOtpScreenState extends State<VerifyOtpScreen> {
  ...
  Future<void> _handleVerifyCode() async {
    ...
    try {
      ...
      final response = await authService.verifyPasswordResetToken(
        _otpController.text,
        widget.email,
      );
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              const SignupProgressBar(currentStep: 2, totalSteps: 4),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'For your security, this code will expire in 10 minutes. If you don\'t receive it, check your spam folder.',
                        style: TextStyle(
