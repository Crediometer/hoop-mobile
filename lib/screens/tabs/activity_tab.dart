                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('In Groups', style: TextStyle(color: Colors.white70, fontSize: 12)),
                              const SizedBox(height: 6),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text('Pending', style: TextStyle(color: Colors.white70, fontSize: 12)),
                              const SizedBox(height: 6),
                              Text('0 transactions', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ),
                      ],
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: selectedIndex == 0 ? (isDark ? const Color(0xFF1E2430) : Colors.white) : Colors.transparent,
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: Center(
                            child: Text('Deposit', style: TextStyle(color: selectedIndex == 0 ? (isDark ? Colors.white : Colors.black87) : Colors.white54)),
                          ),
                        ),
                      ),
                    ),
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          padding: const EdgeInsets.symmetric(vertical: 12),
                          decoration: BoxDecoration(
                            color: selectedIndex == 1 ? (isDark ? const Color(0xFF1E2430) : Colors.white) : Colors.transparent,
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: Center(
                            child: Text('Withdrawal', style: TextStyle(color: selectedIndex == 1 ? (isDark ? Colors.white : Colors.black87) : Colors.white54)),
                          ),
                        ),
                      ),
                    ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        height: 72,
                        decoration: BoxDecoration(
                          color: isDark ? const Color(0xFF0F2A17) : const Color(0xFFEFFCF1),
                          borderRadius: BorderRadius.circular(14),
                        ),
                        child: const Center(
                          child: Icon(Icons.download_rounded, color: Color(0xFF00C853), size: 34),
                        ),
                      ),
                      ...
                      Text(
                        selectedIndex == 0 ? 'No deposits yet' : 'No withdrawals yet',
                        style: TextStyle(
                          color: isDark ? Colors.white : Colors.black87,
                          fontSize: 16,
